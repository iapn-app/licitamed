    ...
    <div className="min-h-screen bg-[#F8F9FA] flex items-center justify-center">
      <div className="text-center max-w-sm px-4">
        <div className="flex items-center justify-center gap-2.5 mb-8">
          <div className="w-8 h-8 rounded-md bg-[#1A56DB] flex items-center justify-center">
        ...
        <Link
          href="/"
          className="inline-flex items-center gap-2 bg-[#1A56DB] text-white text-sm font-medium px-5 py-2.5 rounded-md hover:bg-[#1547BF] transition-colors"
        >
